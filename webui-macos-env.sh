...
export TORCH_COMMAND="pip install git+https://github.com/brkirch/pytorch@88b0249239f225c8f443330cc0de5b192e563573#egg=torch torchvision==0.15.1 -f https://download.pytorch.org/whl/nightly/cpu/torch_nightly.html --no-deps"
