...
def list_models():
    ...
    with list_models_lock:
        try:
            ...
            model_list = modelloader.load_models(model_path=model_path, model_url=model_url, command_path=shared.cmd_opts.ckpt_dir, ext_filter=[".ckpt", ".safetensors"], download_name="sd_xl_base_1.0_0.9vae.safetensors", ext_blacklist=[".vae.ckpt", ".vae.safetensors"])
